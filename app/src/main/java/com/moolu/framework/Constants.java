...
public class Constants {
    ...
    public final static String PREVENT_BEFORE = "file:///";

    public final static int SYSTEMEXIT=1;
    public final static int DIALOGDISMISS=2;
    public final static String ISFIRSTTIMELOGON="firstTimelogon";
    public final static String ISFIRSTTIMEDOWNLOADZIP="firstTimeDownloadZip";
    public final static String FIRSTTIMELOGON="firstlogon";
    public final static String FIRSTTIMEDOWNLOADZIP="firstTimeDownload";

    public final static int DIAGLOGAPPUPDATE=1;
    public final static int DIAGLOGZIPUPDATE=2;
    public final static int DIAGLOGFIRSTTIME=3;
    public final static int CONFIRMDIALOG=4;

    public final static int ERRORENTITY=0x01;
    public final static int ERRORZIP=0x02;
    public final static int ERRORAPK=0x03;
}
